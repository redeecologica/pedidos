<?php
  ...
  $conf = (ctype_digit((string)$cha_id) && (int)$cha_id > 0)
        ? balanco_da_chamada($cha_id) : null;
...
<?php abas_entregas('balanco'); ?>
<br>

<form class="form-inline hidden-print" method="get" action="balanco.php">
  ...
  <?php
    // AO LADO DO SELETOR, e não no rodapé: é onde quem vai usar a tela já está olhando
    // quando escolhe a chamada. O pedido é explícito — se o número parecer errado, que a
    // pessoa avise, em vez de concluir sozinha que o sistema está certo ou que está errado.
  ?>
  &nbsp;&nbsp;<span class="small text-muted">
    <i class="glyphicon glyphicon-info-sign"></i>
    <strong>Funcionalidade em teste.</strong> Encontrou algo estranho? Avise no grupo.
  </span>
</form>
<br>
